          ...
          {similarProducts.map((product) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <h3 className="text-lg font-semibold">{product.title}</h3>
                <p className="text-gray-500">{product.fitAndCare[0]}</p>
                <p className="text-gray-800 font-bold">AED:{product.price}</p>
                <button 
                  className="mt-4 bg-transparent hover:bg-gray-200 text-black font-semibold py-2 px-4 border border-gray-300 rounded-full"
