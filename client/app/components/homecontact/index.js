      ...
      >
        ...
        <div className="rounded-lg pb-36 shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8">
          ...
          <div className="flex justify-center items-center space-x-1">
            ...
            <Link target='_blank' href="https://www.instagram.com/nilaa_trends?igsh=ZWw0M2FjdThrbGxn" className="inline-flex justify-center p-2 text-gray-800 rounded-lg cursor-pointer  hover:text-blue-700">
