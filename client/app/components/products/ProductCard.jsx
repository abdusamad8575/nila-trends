...
const ProductCard = ({ image, category, ProId, title, fit, price, sale_rate, onClick, onWishlistClick, isInWishlist }) => (
   <>
      <div className="hidden md:block bg-white rounded-lg overflow-hidden shadow-md cursor-pointer flex-col relative">
         <button
